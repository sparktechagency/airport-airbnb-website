    ...
    useEffect(() => {
        if (id) {
            ...
            myFetch(`/hotel/${id}`, {
                ...
                setSelectedFacilities(data.facilities?.map((facility: { _id: string }) => facility._id) || []);
            ...
            <Form form={form} onFinish={onFinish} layout='vertical' >
                ...
                <div className='pb-8'>
                    ...
                    <div className='lg:w-1/2 border border-gray-300 rounded'>
                        <ClosureCalendar setDate={setRoomClosureDates} unavailableDay={[]} selectedDate={roomClosureDates} />
                    </div>
                </div>
